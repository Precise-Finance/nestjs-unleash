...
export interface UnleashClientModuleOptionsFactory {
    createStrategiesOptions(): Promise<UnleashClientModuleOptions> | UnleashClientModuleOptions;
}
export interface UnleashClientModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
    ...
    useFactory?: (...args: any[]) => Promise<UnleashClientModuleOptions> | UnleashClientModuleOptions;
}
